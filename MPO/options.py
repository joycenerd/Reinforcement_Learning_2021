...
parser.add_argument("--env", type=str, default="BipedalWalker-v3",
                    help="(str) which task in the OpenAI gym to do: [BipedalWalker-v2, Walker2d-v2, Hopper-v2, Acrobot-v1, Humanoid-v2]")
...
parser.add_argument("--eps-sigma", type=float, default=1e-4,
